...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=NOTE07-S14; initial catalog=inlockGames_DBfirts_manha; User Id = sa; Pwd = Senai@134; TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => e.IdEstudio).HasName("PK__Estudio__0C3B435574EF69FA");
        ...
        {
            entity.HasKey(e => e.IdJogo).HasName("PK__Jogo__69E08513FCAA27F2");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__CA04062BE73D444D");
        ...
        {
            entity.HasKey(e => e.Usuario1).HasName("PK__Usuario__E3237CF627C37BD6");
